...
class TestRhythmTree(unittest.TestCase):
    def test_parse_rhythm(self):
        ...
        ast = hyperscore.parse_rhythm("1[1 (2 1)*2]")
        ticks = hyperscore.rhythm_to_ticks(ast, total_ticks=700)
        self.assertEqual(ticks, [100, 200, 100, 200, 100])
        ...
        ast = hyperscore.parse_rhythm("1/5")
        with self.assertRaises(ValueError):
            hyperscore.rhythm_to_ticks(ast, total_ticks=4)
